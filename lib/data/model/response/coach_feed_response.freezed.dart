...
mixin _$CoachFeedResponse {
 ...
 int? get id; String? get feedType;@JsonKey(name: 'feedData') String? get feedDataResponse; int? get commentCount;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CoachFeedResponse&&(identical(other.id, id) || other.id == id)&&(identical(other.feedType, feedType) || other.feedType == feedType)&&(identical(other.feedDataResponse, feedDataResponse) || other.feedDataResponse == feedDataResponse)&&(identical(other.commentCount, commentCount) || other.commentCount == commentCount));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,feedType,feedDataResponse,commentCount);

@override
String toString() {
  return 'CoachFeedResponse(id: $id, feedType: $feedType, feedDataResponse: $feedDataResponse, commentCount: $commentCount)';
}
...
@useResult
$Res call({
 int? id, String? feedType,@JsonKey(name: 'feedData') String? feedDataResponse, int? commentCount
});
...
/// Create a copy of CoachFeedResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? feedType = freezed,Object? feedDataResponse = freezed,Object? commentCount = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String? feedType, @JsonKey(name: 'feedData')  String? feedDataResponse,  int? commentCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CoachFeedResponse() when $default != null:
return $default(_that.id,_that.feedType,_that.feedDataResponse,_that.commentCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String? feedType, @JsonKey(name: 'feedData')  String? feedDataResponse,  int? commentCount)  $default,) {final _that = this;
switch (_that) {
case _CoachFeedResponse():
return $default(_that.id,_that.feedType,_that.feedDataResponse,_that.commentCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String? feedType, @JsonKey(name: 'feedData')  String? feedDataResponse,  int? commentCount)?  $default,) {final _that = this;
switch (_that) {
case _CoachFeedResponse() when $default != null:
return $default(_that.id,_that.feedType,_that.feedDataResponse,_that.commentCount);case _:
  return null;
...
class _CoachFeedResponse implements CoachFeedResponse {
  const _CoachFeedResponse({this.id, this.feedType, @JsonKey(name: 'feedData') this.feedDataResponse, this.commentCount});
...
/// Create a copy of CoachFeedResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? feedType = freezed,Object? feedDataResponse = freezed,Object? commentCount = freezed,}) {
