...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T value)?  success,TResult Function()?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case SuccessResult() when success != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( T value)  success,required TResult Function()  failure,}) {final _that = this;
switch (_that) {
case SuccessResult():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T value)?  success,TResult? Function()?  failure,}) {final _that = this;
switch (_that) {
case SuccessResult() when success != null:
return success(_that.value);case FailureResult() when failure != null:
return failure();case _:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FailureResult<T>);
}
